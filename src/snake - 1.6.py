...
#                             if previousX != bfsmap[previousY][previousX].getChildX():
#                                 snake[part].setBodypart("-")
# #                             elif previousX > bfsmap[previousY][previousX].getChildX():
# #                                 snake[part].setBodypart("<")
#                             elif previousY != bfsmap[previousY][previousX].getChildY():
#                                 snake[part].setBodypart("|")
# #                             elif previousY > bfsmap[previousY][previousX].getChildY():
# #                                 snake[part].setBodypart("^")
                        elif part == 1:
...
#                 if previousX != adjacency[previousY][previousX][maxAdj].getX():
#                     snake[part].setBodypart("-")
# #                 elif previousX > adjacency[previousY][previousX][maxAdj].getX():
# #                     snake[part].setBodypart("<")
#                 elif previousY != adjacency[previousY][previousX][maxAdj].getY():
#                     snake[part].setBodypart("|")
# #                 elif previousY > adjacency[previousY][previousX][maxAdj].getY():
# #                     snake[part].setBodypart("^")
...
#     if tempX != previousX:
#         snake[part].setBodypart("-")
# #     elif tempX > previousX:
# #         snake[part].setBodypart("<")
#     elif tempY != previousY:
#         snake[part].setBodypart("|")
# #     elif tempY > previousY:
# #         snake[part].setBodypart("^")    
    previousX = tempX
...
def isHeadFoodTail(x, y, snakePointer):
    head = False
    body = True
    tail = False
    food = False
    if matrix[y][x].getBodypart() == "@":
        for i in range(0, len(adjacency[y][x]) - 1):
            if adjacency[y][x][i].getX() == snakePointer[0].getX() and adjacency[y][x][i].getY() == snakePointer[0].getY():
                ...
                tail = True
            elif search(adjacency[y][x][i].getX(), adjacency[y][x][i].getY(), snakePointer) == False:
                body = False
